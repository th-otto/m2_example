...
PROCEDURE trap5();
BEGIN
  CODE(046FCH, 02700H  ); (* move.w     #$2700,sr *)
  CODE(02F4EH, 0FFFCH  ); (* move.l     a6,-4(a7) *)
  CODE(04E6EH          ); (* move.l     usp,a6 *)
  CODE(02D2FH, 00002H  ); (* move.l     2(a7),-(a6) *)
  CODE(03D17H          ); (* move.w     (a7),-(a6) *)
  CODE(02D2FH, 0FFFCH  ); (* move.l     -4(a7),-(a6) *)
  CODE(048E6H, 0FFFCH  ); (* movem.l    d0-d7/a0-a5,-(a6) *)
  CODE(02251H          ); (* movea.l    (a1),a1 *)
  CODE(0208EH          ); (* move.l     a6,(a0) *)
  CODE(047FAH, 0002AH  ); (* lea.l      trap5ret(pc),a3 *)
  CODE(02D0BH          ); (* move.l     a3,-(a6) *)
  CODE(03D3CH, 04EB9H  ); (* move.w     #$4EB9,-(a6) *)
  CODE(03D3CH, 02700H  ); (* move.w     #$2700,-(a6) *)
  CODE(03D3CH, 046FCH  ); (* move.w     #$46FC,-(a6) *)
  CODE(0248EH          ); (* move.l     a6,(a2) *)
  CODE(02C49H          ); (* movea.l    a1,a6 *)
  CODE(04CDEH, 03FFFH  ); (* movem.l    (a6)+,d0-d7/a0-a5 *)
  CODE(02F5EH, 0FFFCH  ); (* move.l     (a6)+,-4(a7) *)
  CODE(03E9EH          ); (* move.w     (a6)+,(a7) *)
  CODE(02F5EH, 00002H  ); (* move.l     (a6)+,2(a7) *)
  CODE(04E66H          ); (* move.l     a6,usp *)
  CODE(02C6FH, 0FFFCH  ); (* movea.l    -4(a7),a6 *)
  CODE(04E73H          ); (* rte *)
(* trap5ret: *)
  CODE(02F4EH, 0FFFCH  ); (* move.l     a6,-4(a7) *)
  CODE(04E6EH          ); (* move.l     usp,a6 *)
  CODE(02D2FH, 00006H  ); (* move.l     6(a7),-(a6) *)
  CODE(03D2FH, 00004H  ); (* move.w     4(a7),-(a6) *)
  CODE(02D2FH, 0FFFCH  ); (* move.l     -4(a7),-(a6) *)
  CODE(048E6H, 0FFFCH  ); (* movem.l    d0-d7/a0-a5,-(a6) *)
  CODE(0205FH          ); (* movea.l    (a7)+,a0 *)
  CODE(02268H, 00024H  ); (* movea.l    36(a0),a1 *)
  CODE(0228EH          ); (* move.l     a6,(a1) *)
  CODE(02C48H          ); (* movea.l    a0,a6 *)
  CODE(04CDEH, 03FFFH  ); (* movem.l    (a6)+,d0-d7/a0-a5 *)
  CODE(02F5EH, 0FFFCH  ); (* move.l     (a6)+,-4(a7) *)
  CODE(03E9EH          ); (* move.w     (a6)+,(a7) *)
  CODE(02F5EH, 00002H  ); (* move.l     (a6)+,2(a7) *)
